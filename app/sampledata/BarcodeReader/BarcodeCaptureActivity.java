 ...
 */
package reader.com.nipponit.readerapp.BarcodeReader;
...
import reader.com.nipponit.readerapp.MainActivity;
import reader.com.nipponit.readerapp.R;
import reader.com.nipponit.readerapp.ui.camera.CameraSource;
import reader.com.nipponit.readerapp.ui.camera.CameraSourcePreview;

import reader.com.nipponit.readerapp.ui.camera.GraphicOverlay;
...
public final class BarcodeCaptureActivity extends AppCompatActivity implements BarcodeGraphicTracker.BarcodeUpdateListener {
    ...
    public void onBarcodeDetected(Barcode barcode)
    {
        ...
        String Mybarcode = barcode.displayValue;
        new AddScanBarcodes().execute(Mybarcode);
    }
    ...
    class AddScanBarcodes extends AsyncTask<String,Integer,Integer> {
        ...
        protected void onPostExecute(Integer integer) {
            ...
            if(!isValid){
                Toast.makeText(BarcodeCaptureActivity.this, "Already scanned barcode.", Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        protected void onPostExecute(String response) {
            ...
            if(response!=null){
                try {
                    ...
                    if(res.equals("0")){
                        Toast.makeText(BarcodeCaptureActivity.this, "Done.You scanned one or more duplicate barcode.", Toast.LENGTH_SHORT).show();
                    }else if(res.equals("1")){
                        Toast.makeText(BarcodeCaptureActivity.this, "Barcode uploaded successfully.", Toast.LENGTH_SHORT).show();
                    }
                ...
                Toast.makeText(BarcodeCaptureActivity.this, "Connection error. Check your internet connection.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private String SendBarcodes(){
        try{
            LocalDb = new AppDB(BarcodeCaptureActivity.this);
